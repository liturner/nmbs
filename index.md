...
* **[ADatP 4774 Ed.A V.1](https://nso.nato.int/nso/nsdd/main/standards/ap-details/1967/EN)** — *CONFIDENTIALITY METADATA LABEL SYNTAX*
  Defines the structure and XML schema used to express confidentiality labels attached to data objects.
* **[ADatP 4778 Ed.A V.1](https://nso.nato.int/nso/nsdd/main/standards/ap-details/1968/EN)** — *METADATA BINDING MECHANISM*
  Defines the methods for securely encapsulating and binding metadata (such as ADatP 4774 labels) to data payloads.
